...
public class LastrumCore {
    ...
    public void init(FMLInitializationEvent event){
        ...
        RenderManager renderManager = m.c.func_175598_ae();
        ...
        //Commands
        CommandHandler.func_71560_a(new Plancke());
        CommandHandler.func_71560_a(new Sk1er());
        CommandHandler.func_71560_a(new Notifly());
        CommandHandler.func_71560_a(new Hypixel());
        CommandHandler.func_71560_a(new AllSites());
        CommandHandler.func_71560_a(new LastrumCommand());
        CommandHandler.func_71560_a(new OpenConfig());
        CommandHandler.func_71560_a(new PlayCommandTab());
