...
public class AllSites extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (Desktop.isDesktopSupported()) {
            ...
            sender.addChatMessage(CC.of("\u00a7bPlancke: \u00a77\u00a7n" + urlplancke)
            ...
            sender.addChatMessage(CC.of("\u00a7eSk1er: \u00a77\u00a7n" + urlsk1er)
            ...
            sender.addChatMessage(CC.of("\u00a7aNotifly: \u00a77\u00a7n" + urlnotifly)
            ...
            sender.addChatMessage(CC.of("\u00a76Hypixel: \u00a77\u00a7n" + urlhypixel)
